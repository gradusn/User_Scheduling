...
class QLearningTable:
    ...
    def save_table(self):
        self.q_table.to_pickle("qtable_SU_example_5tti_convergence_UE1G0703UE20307.pkl")

    def load_table(self):
        self.q_table = pd.read_pickle("qtable_SU_example_5tti_convergence_UE1G0703UE20307.pkl")
