...
class QLearningTable:
    ...
    def save_table(self, table1, table2):
        self.q_table.to_pickle("qtable_SU_example_5tti_UE1GNACK0_UE2BNACK02_UE3BNACK02accumthr.pkl")
    ...
    def load_table(self):
        ...
        self.q_table = pd.read_pickle("qtable_SU_example_5tti_35iter_UE1G07B03_UE2B0703_UE3B0703_accum_thr.pkl")

        #self.q_table = pd.read_pickle("qtable_SU_example_5tti_250iter_UE1G_UE2B0703_UE3B0703_UE4B0703_accum_thr.pkl")
