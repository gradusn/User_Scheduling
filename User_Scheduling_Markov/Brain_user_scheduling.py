...
class QLearningTable:
    ...
    def save_table(self, table1, table2):
        self.q_table.to_pickle("qtable_SU_example_3tti_15iter.pkl")
        np.save("table_ue1_3tti.npy", table1)
        np.save("table_ue2_3tti.npy", table2)

    def load_table(self):
        self.q_table = pd.read_pickle("qtable_SU_example_6tti_50_militer_gains_26_1_test5_0802_0901.pkl")
