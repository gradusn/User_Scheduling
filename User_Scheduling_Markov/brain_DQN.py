...
class DeepQNetwork:
    ...
    def save_mode(self):
        ...
        save_path = self.saver.save(self.sess, "model_2_ues_gb_SU_5tti_noavg_p01q09_rd09_lr001_30militer.ckpt")



    def load_model(self):
        self.saver.restore(self.sess, "model_2_ues_gb_SU_5tti__noavg_p01q09_rd05_lr001_15militer.ckpt")
